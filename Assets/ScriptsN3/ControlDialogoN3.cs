...
public class ControlDialogoN3 : MonoBehaviour
{
    ...
    void Start()
    {
        puntosN3=PlayerPrefs.GetInt("VariablePuntosN3", puntosN3=0);
        //puntosN3=0;
    ...
    public void Trofeo(){
        puntosN3++;
        RevisionPuntaje();
        PlayerPrefs.SetInt("VariablePuntosN3", puntosN3);
        /*if (puntosN3 == 5){
            ButtonSN();
        } */
    }
