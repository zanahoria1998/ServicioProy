...
public class ObjetoInteractableN3 : MonoBehaviour
{
    ...
    public void OnMouseDown(){ //Al presionar un objeto que tenga este script
        ...
        FindObjectOfType<ControlDialogoN3>().ActivarCartel(textos);//buscará el objeto que tenga el control de dialógo y posteriormente recurrirá al método de activar cartel
