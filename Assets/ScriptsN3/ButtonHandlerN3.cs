...
public class ButtonHandlerN3 : MonoBehaviour
{
   ...
   public void OnClickReturn(){
      ...
      if(actualDisplay.actualEstado == DisplayImageN3.Estado.zoom){
         ...
         Resources.Load<Sprite>("EscenaN3/Pared" + actualDisplay.ParedActual);

         actualDisplay.actualEstado = DisplayImageN3.Estado.normal;
      }
   }
