...
public class ButtonBehaviourN2 : MonoBehaviour
{
    ...
    void esconderDisplay(){
        ...
        if(actualDisplay.actualEstado == DisplayImageN2.Estado.normal && ThisButtonId == ButtonId.returnButton){
        ...
        if(!(actualDisplay.actualEstado == DisplayImageN2.Estado.normal) && ThisButtonId == ButtonId.roomChangeButton){
