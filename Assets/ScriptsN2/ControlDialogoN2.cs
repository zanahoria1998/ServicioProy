...
public class ControlDialogoN2 : MonoBehaviour
{
    ...
    void Start()
    {
        puntosN2=PlayerPrefs.GetInt("VariablePuntosN2", puntosN2=0);
        //puntosN2=0;
    ...
    public void Trofeo(){
        puntosN2++;
        RevisionPuntaje();
        PlayerPrefs.SetInt("VariablePuntosN2", puntosN2);
        /*if (puntosN2 == 5){
            ButtonSN();
        } */
    }
