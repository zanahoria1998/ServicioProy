...
public class ControlDialogoN6 : MonoBehaviour
{
    ...
    void Start()
    {
        puntosN6=PlayerPrefs.GetInt("VariablePuntosN6", puntosN6=0);
        //puntosN6=0;
    ...
    public void Trofeo(){
        puntosN6++;
        RevisionPuntaje();
        PlayerPrefs.SetInt("VariablepuntosN6", puntosN6);
        /*if (puntosN6 == 5){
            ButtonSN();
        } */
    }
