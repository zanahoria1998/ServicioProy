...
public class ButtonBehaviourN6 : MonoBehaviour
{
    ...
    void esconderDisplay(){
        ...
        if(actualDisplay.actualEstado == DisplayImageN6.Estado.normal && ThisButtonId == ButtonId.returnButton){
        ...
        if(!(actualDisplay.actualEstado == DisplayImageN6.Estado.normal) && ThisButtonId == ButtonId.roomChangeButton){
