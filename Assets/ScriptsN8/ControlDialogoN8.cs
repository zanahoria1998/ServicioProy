...
public class ControlDialogoN8 : MonoBehaviour
{
    ...
    void Start()
    {
        puntosN8=PlayerPrefs.GetInt("VariablePuntosN8", puntosN8=0);
        //puntosN8=0;
    ...
    public void Trofeo(){
        puntosN8++;
        RevisionPuntaje();
        PlayerPrefs.SetInt("VariablepuntosN8", puntosN8);
        /*if (puntosN8 == 5){
            ButtonSN();
        } */
    }
