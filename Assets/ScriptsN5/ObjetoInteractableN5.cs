...
public class ObjetoInteractableN5 : MonoBehaviour
{
    ...
    public void OnMouseDown(){ //Al presionar un objeto que tenga este script
        ...
        FindObjectOfType<ControlDialogoN5>().ActivarCartel(textos);//buscará el objeto que tenga el control de dialógo y posteriormente recurrirá al método de activar cartel
