...
public class ButtonBehaviourN5 : MonoBehaviour
{
    ...
    void esconderDisplay(){
        ...
        if(actualDisplay.actualEstado == DisplayImageN5.Estado.normal && ThisButtonId == ButtonId.returnButton){
        ...
        if(!(actualDisplay.actualEstado == DisplayImageN5.Estado.normal) && ThisButtonId == ButtonId.roomChangeButton){
