...
public class ControlDialogoN4 : MonoBehaviour
{
    ...
    void Start()
    {
        puntosN4=PlayerPrefs.GetInt("VariablePuntosN4", puntosN4=0);
        //puntosN4=0;
    ...
    public void Trofeo(){
        puntosN4++;
        RevisionPuntaje();
        PlayerPrefs.SetInt("VariablePuntosN4", puntosN4);
        /*if (puntosN4 == 5){
            ButtonSN();
        } */
    }
