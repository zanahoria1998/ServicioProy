...
public class ButtonBehaviourN4 : MonoBehaviour
{
    ...
    void esconderDisplay(){
        ...
        if(actualDisplay.actualEstado == DisplayImageN4.Estado.normal && ThisButtonId == ButtonId.returnButton){
        ...
        if(!(actualDisplay.actualEstado == DisplayImageN4.Estado.normal) && ThisButtonId == ButtonId.roomChangeButton){
